...
def login(request):
    ...
    content = {'title': 'login', 'login_form': login_form, 'name': 'Log in'}
...
{settings.DOMAIN_NAME} перейдите по ссылке: \n{settings.DOMAIN_NAME}{verify_link}'
    from_addres = settings.EMAIL_HOST_USER
    return send_mail(title, message, from_addres, [user.email], fail_silently=False )